...
REM We must use Perl for Windows (normally it is ActiveState Perl), don't use per for MSys2
C:\Perl64\bin\perl.exe Configure %VCFLAG% no-shared --prefix="%CurDir%/build.msvc/win_%CONFIGURATION%_%PLATFORM%"
